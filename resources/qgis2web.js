...
map.getView().fit([11191536.845491, 597013.130097, 11202101.294096, 603276.170098], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">PEMETAAN TEMPAT MAKAN BAJET UNTUK PELAJAR PTSB DI KULIM</h2>';
        return titleElement;
    })(),
...
var searchLayer = new SearchLayer({
    layer: lyr_NAMAKEDAIMAKAN_6,
    colName: 'NAMA TEMPAT KEDAI MAKAN',
    zoom: 10,
    collapsed: true,
    map: map
});
