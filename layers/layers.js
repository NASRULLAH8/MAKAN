...
//ol.proj.get("EPSG:3857").setExtent([11191536.845491, 597013.130097, 11202101.294096, 603276.170098]);
var wms_layers = [];
...
var lyr_TEMPATKHAS_5 = new ol.layer.Vector({
    ...
    <img src="styles/legend/TEMPATKHAS_5_0.png" /> POLITEKNIK TUANKU SULTANAH BAHIYAH<br />\
    <img src="styles/legend/TEMPATKHAS_5_1.png" /> UNIVERSITI KUALA LUMPUR<br />\
    <img src="styles/legend/TEMPATKHAS_5_2.png" /> HOSPITAL KULIM<br />\
    <img src="styles/legend/TEMPATKHAS_5_3.png" /> BALAI POLIS<br />\
    <img src="styles/legend/TEMPATKHAS_5_4.png" /> BALAI BOMBA<br />\
    <img src="styles/legend/TEMPATKHAS_5_5.png" /> KOLEJ KOMUNITI KULIM<br />'
        });
...
lyr_NAMAKEDAIMAKAN_6.set('fieldLabels', {'NAMA TEMPAT KEDAI MAKAN': 'inline label - always visible', 'LONGITUDE': 'inline label - always visible', 'LATITUDE': 'inline label - always visible', 'ALAMAT': 'inline label - always visible', 'HARI OPERASI': 'inline label - always visible', 'WAKTU OPERASI': 'inline label - always visible', 'WAKTU MAKAN': 'inline label - always visible', 'NO TELEFON': 'inline label - always visible', 'MENU UTAMA': 'inline label - always visible', 'MENU KEGEMARAN': 'inline label - always visible', 'ANGGARAN HARGA': 'inline label - always visible', 'GAMBAR KEDAI': 'inline label - always visible', });
